...
for i in range(total_time):
    ...
    phi_z[is_z_absorption] = absorption_z[is_z_absorption] * phi_z[is_z_absorption] + (absorption_z[is_z_absorption] - 1) * z_diff_1[is_z_absorption]
    phi_x[is_x_absorption] = absorption_x[is_x_absorption] * phi_x[is_x_absorption] + (absorption_x[is_x_absorption] - 1) * x_diff_1[is_x_absorption]
    ...
    psi_z[is_z_absorption] = absorption_z[is_z_absorption] * psi_z[is_z_absorption] + (absorption_z[is_z_absorption] - 1) * z_diff_2[is_z_absorption]
    psi_x[is_x_absorption] = absorption_x[is_x_absorption] * psi_x[is_x_absorption] + (absorption_x[is_x_absorption] - 1) * x_diff_2[is_x_absorption]
